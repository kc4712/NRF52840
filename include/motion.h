...
#define MEMS_400HZ_ODR 0
#define MEMS_100HZ_ODR 1
#define MEMS_50HZ_ODR  2
...
#define ODR_MODE_TAB			0
#define ODR_MODE_STEP			1
...
#define  MOTION_I2C_ADDRESS  0x32
...
status_t LIS3DH_DISABLE_HPF(void);
