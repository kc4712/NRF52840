...
#define SPI0_USE_EASY_DMA 1
	  ...
	  #define SPI1_CONFIG_SCK_PIN         	26
	  #define SPI1_CONFIG_MOSI_PIN        	29
	  #define SPI1_CONFIG_MISO_PIN        	28
...
#define SPI1_ENABLED 1 /* Flash */

#if (SPI1_ENABLED == 1)
#define SPI1_USE_EASY_DMA 						1
#define SPI1_CONFIG_SCK_PIN         	13 
#define SPI1_CONFIG_MOSI_PIN        	15 
#define SPI1_CONFIG_MISO_PIN        	14

#define SPI1_CONFIG_IRQ_PRIORITY    APP_IRQ_PRIORITY_LOW
#define SPI1_INSTANCE_INDEX 1
#endif /* #if (SPI1_ENABLED == 1) */


#ifdef GC_COACH_FIT_PCB_PAHR_IF_TWI
	#define SPI2_ENABLED 0 /* PAH8002 Heart rate */
#else
	#define SPI2_ENABLED 1 /* PAH8002 Heart rate */
#endif 

#if (SPI2_ENABLED == 1)
	#define SPI2_USE_EASY_DMA 1
 #ifdef GC_COACH_FIT_PCB
	 #define SPI2_CONFIG_SCK_PIN         	3
	 #define SPI2_CONFIG_MOSI_PIN        	5
	 #define SPI2_CONFIG_MISO_PIN          	4
 #elif defined GC_COACH_FIT_DK52
	 #define SPI2_CONFIG_SCK_PIN         	26
	 #define SPI2_CONFIG_MOSI_PIN        	29
	 #define SPI2_CONFIG_MISO_PIN        	28
#endif 
...
#define TWI1_CONFIG_SCL          3
#define TWI1_CONFIG_SDA          5
